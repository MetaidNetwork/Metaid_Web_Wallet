...
<div class="login-container main-container">
  <img :src="'static/img/chain/metaidcosmos.JPG'" width="100%">
  <div class="info">
...
export default {
  ...
  methods:{
    ...
    login(){
      ...
      this.webUtil.initMetaidExtension().then((res) => {
        return metaidExtension.getIdentity(network);
      }).then((identity) => {
        ...
        window.location.href = 'src/components/cosmos';
        alert(this.$t('noMetaidExtension'));
      })
    }
  }
}
